	...
	return (
		<main className="bg-dark p-0 m-0 vh-100 vw-100 d-flex justify-content-center align-items-center">
			<div className="container-fluid row">
				<div className="card m-2 p-2 w-75 col-12 col-md-10 mx-auto bg-dark text-light rounded border border-2 bg-custom-dark">
					<div className={`img-uploader-main-${process.env.IMG_UPLOADER_THEME}`}>
